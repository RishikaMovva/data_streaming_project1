...
class KafkaConsumer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            ...
            'default.topic.config': {"acks":"all", "auto.offset.reset": "earliest"}
        }
    ...
    async def consume(self):
        ...
        while True:
            num_results = 1
            logger.info("one result received from kafka topic")
            while num_results > 0:
                num_results = self._consume()
            logger.info("more than one results received from kafka topic")
